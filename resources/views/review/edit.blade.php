                    ...
                    <form action="{{ route('review.update', $review->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-12 gap-5 ">
                            <div class="col-span-12 lg:col-span-8 bg-white dark:bg-gray-800 p-4 rounded-lg">
                                ...
                                <div class="py-2">
                                    <textarea name="review" class="ckeditor" id="editor" cols="30" rows="10">{{ $review->review }}</textarea>
                                    @error('review')
                            ...
                            <div class="col-span-12 lg:col-span-4 bg-white dark:bg-gray-800 p-4 rounded-lg">
                                ...
                                <div class="py-2">
                                    <select id="" name="rating"
                                        ...
                                        <option value="1" @if ($review->rating == 1) selected @endif>One Star</option>
                                        <option value="2" @if ($review->rating == 2) selected @endif>Two Star</option>
                                        <option value="3" @if ($review->rating == 3) selected @endif>Three Star</option>
                                        <option value="4" @if ($review->rating == 4) selected @endif>Four Star</option>
                                        <option value="5" @if ($review->rating == 5) selected @endif>Five Star</option>
                                    </select>
                                    <x-form.input label="Review Date" name="date" type="date" value="{{ $review->date->format('Y-m-d') }}" />
                                </div>
