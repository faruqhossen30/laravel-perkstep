                ...
                @foreach ($reviews as $review)
                    <div class="col-span-4  group ">
                        <div class=" text-center ">
                            ...
                            <div class=" mt-2 mx-5 text-center w-0 h-0 border-[25px]  border-transparent  group-hover:border-b-[#01C778] border-b-[#F8F8F8] border-t-0 "></div>
                        </div>
                        <div class="group bg-[#F8F8F8] p-6 rounded group-hover:bg-[#01C778] group-hover:text-white">

                            <div class="flex group-hover:text-white">
