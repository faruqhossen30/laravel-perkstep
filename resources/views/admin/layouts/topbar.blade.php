        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ route('dashboard') }}" class="flex items-center ml-2 md:mr-24 cursor-pointer">
                    <img src="{{asset('storage/'.$site->logo)}}" class="h-10  w-40 mr-3" alt="" />
                    <span
                        ...
                        <ul class="py-1" role="none">
                            <li>
                                <a href="{{route('dashboard')}}"
                                    class="inline-flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                                    role="menuitem">
                            ...
                            <li class="">
                                <a href="{{route('website.setting')}}"
                                    class="inline-flex items-center  justify-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white "
                                    role="menuitem">
                                    <svg class="w-5 h-5 mr-2 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white "
