                    ...
                    <div class=" rounded-md text-center ">
                        <div class="relative">
                            <img src="{{ asset('storage/' . $blog->thumbnail) }}" alt=""
                                class="rounded-md img-cover w-full h-auto mb-7">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-5 prose-xl">
                                ...
                                <div>
                                    <p class="mb-0 text-gray-500 text-justify ">{!! $blog->description !!}</p>
                                </div>
                            </div>
                            ...
                            <div class="pt-3 mt-4">
                                <ul class="flex flex-wrap items-center gap-3 mb-0">
                                    ...
                                    <li class="mt-1">
                                        ...
                                        <a href="https://twitter.com/intent/tweet?url={{ route('single.blog.page', $blog->id) }}"
                                            target="_blank"
