        ...
        <div class="container mx-auto py-5 ">
            <div class="grid grid-cols-12   py-16">
                ...
                <div class="col-span-3 space-y-6">
                    ...
                    <a href="{{ route('blog.page') }}"target="_blank" class=" space-y-3">
                        <div class="flex items-center  space-x-3 hover:text-green-500 group ">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="h-4 w-4 ">
                                <path fill-rule="evenodd"
                            ...
                            <p class="text-base text-white group-hover:text-green-500 font-medium">Blogs</p>
                        </div>
                    </a>
