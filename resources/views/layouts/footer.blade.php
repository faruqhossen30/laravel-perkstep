...
<footer class="bg-[#0F291F]">
        ...
        <div class="container mx-auto grid grid-cols-12 divide-x  divide-gray-700  ">
            ...
            <div class="col-span-4 ">
                <div class="flex items-center space-x-6 py-6 ">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class=" h-12 w-12  rounded-full text-[#01C778] bg-[#0C4931] p-3">
                        3
    ...
    <div class="container mx-auto">
        <div class="flex justify-between text-white p-3">
            <div class="">
                <p class="text-xs">All Rights Reserved © {{ date('Y') }} <span class="text-sm font-semibold">Perkstep</span></p>
            </div>
