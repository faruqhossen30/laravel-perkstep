...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-gray-100">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <!-- Card -->
        <a href="{{route('single.service.page',$service->slug)}}" class="group flex flex-col focus:outline-none hover:shadow-2xl h-full bg-white border border-gray-200 shadow-sm rounded-xl" href="#">
          <div class="relative pt-[50%] sm:pt-[70%] rounded-t-xl overflow-hidden">
            <img class="size-full absolute top-0 start-0 object-cover group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out rounded-t-xl" src="{{ asset('storage/'.$service->thumbnail) }}" alt="Blog Image">
          </div>
