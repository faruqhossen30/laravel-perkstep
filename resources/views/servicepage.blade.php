...
<div class="max-w-4xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto ">
    <div class="max-w-2xl">
      ...
      <div class="space-y-5 md:space-y-8">
        <p class="text-2xl font-semibold text-gray-700 ">We're proud to be a part of creating a more open culture and to continue building a product that supports this vision.</p>
  ...
  <!-- Sticky Share Group -->
  <div class="sticky bottom-6 inset-x-0 text-center py-10 ">
